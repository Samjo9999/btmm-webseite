...
export default function ZellenPage() {
  const totalMembers = cells.reduce((sum, c) => sum + c.members, 0)
  const totalFocus = new Set(cells.flatMap(c => c.focus)).size
          ...
          <div style={{
            ...
            <SectionReveal delay={cells.length * 0.1}>
              <div className="card-btb" style={{
                ...
                <Link to="/mitmachen" className="btn-primary" style={{
                  display: 'inline-flex',
                  alignItems: 'center',
                  gap: '0.5rem',
                }}>
