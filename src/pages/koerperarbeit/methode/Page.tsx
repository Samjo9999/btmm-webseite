      ...
      <section className="section" style={{ background: 'var(--btb-weiss)' }}>
        <div className="container-btb" style={{ maxWidth: 800 }}>
          ...
          <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
            <RouterLink  to="/koerperarbeit/ablauf" className="btn-primary">
              Weiter: Ablauf
            </RouterLink>
            <RouterLink  to="/koerperarbeit/preise" className="btn-oliv">
              Preise & Buchen
            </RouterLink>
            <RouterLink  to="/koerperarbeit" className="btn-secondary">
              Zurück
            </RouterLink>
          </div>
        </div>
